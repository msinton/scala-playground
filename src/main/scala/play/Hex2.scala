//package play
//
//case class Hex2 protected(id: Int) extends Comparable[Hex2] {
//
...
//
//  val neighbours: mutable.Map[Side, Hex2] = new util.EnumMap[Side, Hex2](classOf[Side])
//
...
//
//  def getSide(hex: Hex2): Option[Side] = neighbours.find { case (_, h) => h == hex } map (_._1)
//
...
//    */
//  override def compareTo(o: Hex2): Int = hexType.compareTo(o.hexType)
//
//  def floodHex(): Unit = {
//    maskedType = hexType
...
//  }
//
//  def neighboursAccessibleByFoot(): collection.Map[Side,Hex2] = {
